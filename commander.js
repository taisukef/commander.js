...
class Command extends EventEmitter {
  ...
  constructor(name) {
    ...
    this._outputConfiguration = {
      writeOut: (str) => console.log(str), // process.stdout.write(str),
      writeErr: (str) => console.log(str), // process.stderr.write(str),
      getOutHelpWidth: () => null, // process.stdout.isTTY ? process.stdout.columns : undefined,
      getErrHelpWidth: () => null, // process.stderr.isTTY ? process.stderr.columns : undefined,
